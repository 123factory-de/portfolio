...
주요 고객군은 연구 개발부터 파일럿, 생산까지 재현성 있는 공정이 필요한 화학, 배터리, 화장품, 제약, 첨단 소재, 전자 소재, 수처리 분야입니다.
...
- 산업 수처리 파트너에게는 난분해성 폐수와 PFAS 처리 수요가 CAVITOX PoC의 출발점입니다.
- 독일 데모룸은 유럽 고객 대상 샘플 테스트와 현지 검증을 시작하기 좋은 접점입니다.
