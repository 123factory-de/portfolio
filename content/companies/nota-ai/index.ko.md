...
[NetsPresso](https://www.kr.nota.ai/netspresso)는 하드웨어의 특성을 이해하는 AI 모델 최적화 플랫폼입니다. 모델 개발, 최적화, 검증을 하나의 환경에서 지원합니다. 구조적 프루닝, 양자화, 그래프 최적화 같은 기법을 적용한 뒤 실제 디바이스에서 검증해 시행착오를 줄입니다.

[Nota Vision Agent](https://www.kr.nota.ai/ai-solutions-notavisionagent)는 생성형 AI로 영상을 실행 가능한 인사이트로 바꾸는 관제 솔루션입니다. 실시간 모니터링과 즉각 알림, 이벤트 요약 리포트, 자연어 기반 질의응답과 영상 검색을 지원합니다. 이와 함께 지능형 교통 시스템(ITS), 운전자 모니터링·얼굴 인식(DMS & FR) 솔루션도 제공합니다.

## 시장 및 활용 분야

노타의 고객은 크게 둘로 나뉩니다. 하나는 제약된 하드웨어에서 효율적인 AI가 필요한 디바이스 제조사와 칩 기업입니다. 다른 하나는 교통, 안전, 관제용 영상지능이 필요한 공공·산업 분야 고객입니다.

차량 번호판 인식, 보행자·쓰러짐 감지, 운전자 모니터링, 도시 교통 흐름 최적화 등이 대표적인 활용 사례입니다. ITS는 기존 CCTV 인프라를 그대로 활용해 구축 비용을 낮춥니다.
...
노타는 칩 기업, 디바이스 OEM, 자동차 부품사, 공공기관과 잘 맞습니다. NetsPresso는 제한된 하드웨어에 고성능 모델을 정확도 손실 없이 올려야 하는 PoC에 특히 적합합니다. Nota Vision Agent와 ITS는 기존 카메라 망을 AI로 고도화하려는 도시·운영 기관에 어울립니다.

한국-유럽 협업 측면에서는 베를린 법인과 도이치텔레콤·Arm 등 유럽 파트너와의 협업 경험이 있어, 유럽의 엣지 AI 및 스마트 모빌리티 프로젝트와 연결되기 좋습니다.
