...
- **`content/companies/beyonddx/index.md` & `index.ko.md`**:
  ...
  4. **Traction & References**: Added ISO 13485 QMS and Korean GMP manufacturing details, 3,400+ specimen dataset, ASCO 2025/2026 presentations, Shanghai Kehua MOU, and Women's Startup Competition Grand Prize.
